            ...
            <div className="lg:col-span-2">
              <div className="space-y-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  />
                  <h3 className="text-2xl font-bold text-white">Idexia Studio</h3>
                </div>
                <p className="text-neutral-300 leading-relaxed">
                  The AI-powered social media manager that helps business owners create engaging content, save time, and grow their audience without the stress.
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h4 className="text-xl font-semibold text-white mb-2">
                Stay Updated with Social Media Tips
              </h4>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 px-4 py-3 bg-neutral-800 border border-neutral-700 rounded-lg text-white placeholder-neutral-400 focus:outline-none focus:border-primary-500"
              />
        ...
        <div className="border-t border-neutral-800 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-neutral-400 text-sm">
              © 2024 Idexia Studio. All rights reserved.
            </p>
